# python main_test_swinir.py --task classical_sr --scale 3 --model_path superresolution/swinir_sr/models/20000_G.pth --folder_lq testing_lr_images/testing_lr_images --folder_gt testsets/answerx3 --training_patch_size 48
import argparse
import cv2
import glob
import numpy as np
